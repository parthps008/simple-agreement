...
from .models import CustomUser,PaymentPending
...
class PaymentPendingForm(forms.ModelForm):
    class Meta:
        model = PaymentPending
        fields = ['name', 'payment_remaining', 'payment_due_date', 'agreement_policies', 'signature']
        widgets = {
